              ...
              <div className="p-6 border-t-[0.5px] border-gallery-line flex flex-col gap-4">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0">
                    {/* Avatar */}
                    <div className="w-8 h-8 rounded-none border-[0.5px] border-gallery-line bg-gallery-dark flex items-center justify-center text-[#F3F1F1] shrink-0 font-serif text-xs font-semibold select-none">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <span className="text-xs font-semibold text-gallery-dark truncate max-w-[130px] font-sans" title={user || 'Administrator'}>
                        {user || 'Administrator'}
                      </span>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="p-2 border-[0.5px] border-gallery-line hover:border-red-700 hover:text-red-700 transition-colors text-gallery-muted cursor-pointer flex items-center justify-center shrink-0"
                    title="Keluar"
                  >
                    <LogOut size={14} />
                  </button>
